...
class MultipleVertexJson(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        for j in range(len(beliefsImg)):
            ...
            # beliefsImg[j].save('{}beliefsImg.png'.format(j))
...
# So what I would do first would be to look at the output of the neural network on the training images to see that it actually
# outputs the belief maps.
